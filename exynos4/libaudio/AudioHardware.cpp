...
//  : You have to modify.
//
const AudioMixer AudioHardware::device_out_SPK[] = {
...
const AudioMixer AudioHardware::device_out_RCV[] = {
    {NULL, NULL}
};
const AudioMixer AudioHardware::device_out_RING_SPK[] = {
    {NULL, NULL}
};
const AudioMixer AudioHardware::device_out_RING_NO_MIC[] = {
    {NULL, NULL}
};
const AudioMixer AudioHardware::device_out_HP_NO_MIC[] = {
    {NULL, NULL}
};
const AudioMixer AudioHardware::device_out_RING_HP[] = {
    {NULL, NULL}
};
const AudioMixer AudioHardware::device_out_HP[] = {
    {NULL, NULL}
};
const AudioMixer AudioHardware::device_out_RING_SPK_HP[] = {
    {NULL, NULL}
};
const AudioMixer AudioHardware::device_out_SPK_HP[] = {
    {NULL, NULL}
};
const AudioMixer AudioHardware::device_out_BT[] = {
    {NULL, NULL}
};
const AudioMixer AudioHardware::device_out_OFF[] = {
    {NULL, NULL}
};


const AudioMixer AudioHardware::device_voice_RCV[] = {
    {NULL, NULL}
};
const AudioMixer AudioHardware::device_voice_SPK[] = {
    {NULL, NULL}
};
const AudioMixer AudioHardware::device_voice_TTY_VCO[] = {
    {NULL, NULL}
};
const AudioMixer AudioHardware::device_voice_TTY_HCO[] = {
    {NULL, NULL}
};
const AudioMixer AudioHardware::device_voice_TTY_FULL[] = {
    {NULL, NULL}
};
const AudioMixer AudioHardware::device_voice_HP_NO_MIC[] = {
    {NULL, NULL}
};
const AudioMixer AudioHardware::device_voice_HP[] = {
    {NULL, NULL}
};
const AudioMixer AudioHardware::device_voice_BT[] = {
    {NULL, NULL}
};
const AudioMixer AudioHardware::device_voice_OFF[] = {
    {NULL, NULL}
};


const AudioMixer AudioHardware::device_input_Main_Mic[] = {
...
const AudioMixer AudioHardware::device_input_Hands_Free_Mic[] = {
    {NULL, NULL}
};
const AudioMixer AudioHardware::device_input_BT_Sco_Mic[] = {
    {NULL, NULL}
};
const AudioMixer AudioHardware::device_input_MIC_OFF[] = {
    {NULL, NULL}
};
// ----------------------------------------------------------------------------
    ...
    if ((mSecRilLibHandle) &&
        ...
        if (mMode == AudioSystem::MODE_IN_CALL) {
            ...
            for(int cnt = 0 ; NULL != mixer[cnt].ctl ; ++cnt){
                TRACE_DRIVER_IN(DRV_MIXER_GET)
                ctl = mixer_get_control(mMixer, mixer[cnt].ctl, 0);
                TRACE_DRIVER_OUT
                if (NULL == ctl) {
                ...
                TRACE_DRIVER_IN(DRV_MIXER_SEL)
                mixer_ctl_set(ctl, mixer[cnt].val);
                TRACE_DRIVER_OUT

                LOGV("setIncallPath_l() setting %s(%d) cnt:%d", mixer[cnt].ctl, mixer[cnt].val, cnt);
            }
        }
    }
    return NO_ERROR;
...
status_t AudioHardware::AudioStreamOutALSA::open_l()
{
    ...
    if (mHardware->mode() != AudioSystem::MODE_IN_CALL) {
        ...
        for(int cnt = 0 ; NULL != mixer[cnt].ctl ; ++cnt){
            TRACE_DRIVER_IN(DRV_MIXER_GET)
            mRouteCtl = mixer_get_control(mMixer, mixer[cnt].ctl, 0);
            TRACE_DRIVER_OUT
            if (NULL == mRouteCtl) {
                LOGE("failed get mixer control");
                return NO_INIT;
            ...
            TRACE_DRIVER_IN(DRV_MIXER_SEL)
            mixer_ctl_set(mRouteCtl, mixer[cnt].val);
            TRACE_DRIVER_OUT
