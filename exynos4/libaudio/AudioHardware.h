...
private:
    ...
    static const AudioMixer device_out_SPK[];
    static const AudioMixer device_out_RCV[];
    static const AudioMixer device_out_RING_SPK[];
    static const AudioMixer device_out_RING_NO_MIC[];
    static const AudioMixer device_out_HP_NO_MIC[];
    static const AudioMixer device_out_RING_HP[];
    static const AudioMixer device_out_HP[];
    static const AudioMixer device_out_RING_SPK_HP[];
    static const AudioMixer device_out_SPK_HP[];
    static const AudioMixer device_out_BT[];
    static const AudioMixer device_out_OFF[];

    static const AudioMixer device_voice_RCV[];
    static const AudioMixer device_voice_SPK[];
    static const AudioMixer device_voice_TTY_VCO[];
    static const AudioMixer device_voice_TTY_HCO[];
    static const AudioMixer device_voice_TTY_FULL[];
    static const AudioMixer device_voice_HP_NO_MIC[];
    static const AudioMixer device_voice_HP[];
    static const AudioMixer device_voice_BT[];
    static const AudioMixer device_voice_OFF[];

    static const AudioMixer device_input_Main_Mic[];
    static const AudioMixer device_input_Hands_Free_Mic[];
    static const AudioMixer device_input_BT_Sco_Mic[];
    static const AudioMixer device_input_MIC_OFF[];
